    ...
    */
    sendEmailConfiguration(emailSender, emailDestination, statusCode = 200) {
        ...
        cy.createDictionaryHeader().then((headers) => {
            cy.request({
                method: 'PUT',
                url: 'web/index.php/api/v2/admin/email-configuration',
                headers: headers,
                body: data
            }).then((response) => {
                expect(response.status).to.eq(statusCode)
    ...
    */
    changeCorpBrand(primaryColor = "#FF7B1D", primaryFontColor = "#FFFFFF", secondaryColor = "#76BC21", secondaryFontColor = "#FFFFFF",
        ...
        cy.createDictionaryHeader().then((headers) => {
            cy.request({
                method: 'PUT',
                url: 'web/index.php/api/v2/admin/theme',
                headers: headers,
                body: data
            }).then((response) => {
                expect(response.status).to.eq(statusCode)
    ...
    */
    activateDeactivateModules(admin = true, pim = true, leave = true, time = true,
        ...
        cy.createDictionaryHeader().then((headers) => {
            cy.request({
                method: 'PUT',
                url: 'web/index.php/api/v2/admin/modules',
                headers: headers,
                body: data,
                failOnStatusCode: false
            }).then((response) => {
    ...
    */
    changeLanguage(language = "en_US", dateFormat = "Y-d-m", leave = true, statusCode = 200) {
        ...
        cy.createDictionaryHeader().then((headers) => {
            cy.request({
                method: 'PUT',
                url: 'web/index.php/api/v2/admin/localization',
                headers: headers,
                body: data,
                failOnStatusCode: false
            }).then((response) => {
